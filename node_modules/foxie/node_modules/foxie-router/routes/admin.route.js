...
function loadMount(){
	query.themeMount
	.then(function(res){
		require("../static/useStatic.js")(settings.selectTheme,settings.purpose) //init the theme set for this mount
		require("../static/assetsCompile.js")(settings.selectTheme,data.themes[settings.selectTheme+"--assets"],settings.purpose)//get assets and libraries for this theme
